 ...
 * @version 2.2.1 - Updated with correct server addresses
 * @copyright 2025
 */
...
function blackwall_ConfigOptions() {
    return [
        'api_key' => [
            ...
            'Type' => 'text',
            'Size' => '50',
            'Default' => 'f00dd040-cb6b-445e-9a92-b7757ee28161',
        ...
        'primary_server' => [
            ...
            'Type' => 'text',
            'Size' => '40',
            'Default' => 'securewall-blackwall1.mydchub.com',
            'Description' => 'Primary Blackwall server address',
        ],
        'secondary_server' => [
            'FriendlyName' => 'Secondary Server',
            'Type' => 'text',
            'Size' => '40',
            'Default' => 'securewall-blackwall2.mydchub.com',
            'Description' => 'Secondary Blackwall server address',
        ],
        'gatekeeper_enabled' => [
        ...
        if (isset($params['model']) && method_exists($params['model'], 'serviceProperties')) {
            try {
                $service_props = [
                    ...
                    'Creation Method' => 'WiseCP Flow v2.2.1 (Updated Servers)',
                ];
    ...
    try {
        ...
        return [
            ...
            'templateVariables' => [
                ...
                'primary_server' => $params['configoption2'] ?? 'securewall-blackwall1.mydchub.com',
                'secondary_server' => $params['configoption3'] ?? 'securewall-blackwall2.mydchub.com',
                'gatekeeper_enabled' => $gatekeeper_enabled,
...
function blackwall_checkModuleVersion(array $params) {
    $version_info = [
        ...
        'version' => '2.2.1 - Updated Server Addresses',
        ...
        'server_addresses' => [
            'primary' => 'securewall-blackwall1.mydchub.com',
            'secondary' => 'securewall-blackwall2.mydchub.com'
        ],
        'function_exists' => [
    ...
    // Test debug logger
    try {
        BlackwallDebugLogger::info('Version check called - Updated server addresses');
    ...
    return "Module Version Info (Updated Servers):\n" . json_encode($version_info, JSON_PRETTY_PRINT);
}
